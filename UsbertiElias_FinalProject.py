...
# Links to help people who want to report a crime
    ...
    if st.button("Safety Tips"):
        webbrowser.open_new_tab('https://bpdnews.com/tips/')

    elif st.button("Emergency 911"):
        webbrowser.open_new_tab('https://bpdnews.com/emergency-911/')

    elif st.button("Boston's Most Wanted List"):
        webbrowser.open_new_tab('https://bpdnews.com/most-wanted/')

    elif st.button("Boston's Police Departments "):
        webbrowser.open_new_tab('https://bpdnews.com/districts')

    elif st.button("Bentley Campus Security Report"):
        webbrowser.open_new_tab('https://www.bentley.edu/files/pdf/Final_ASR.pdf')
